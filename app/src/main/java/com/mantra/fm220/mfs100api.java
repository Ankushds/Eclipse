...
public final class mfs100api {
	...
	*/
    ...
    public static final int  MFS100_E_NOFINGERPRINT = 1102; 	//Employee structure contains no fingerprints (void user).
	    ...
	    public static int CheckError(int returnValue)
	    {
	        ...
	        if(!(returnValue>1100 && returnValue<1400))
	         ...
	         switch (returnValue) {
	            ...
	            case 1102:  ErrorString = "Employee structure contains no fingerprints (void user)"; return -1;
